using Onion_Emarket.Persistence;
...
using Onion_Emarket.Web.Models;
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        Onion_EmarketDbContext dbContext = scope.ServiceProvider.GetRequiredService<Onion_EmarketDbContext>();
...
void Bogus(Onion_EmarketDbContext context)
{
